...
class SelfImprovementEngine:
    ...
    BENCHMARKS = [
        ...
        },
        {
            ...
            "pass_keywords": ["don't have", "not available", "don't know", "no data", "couldn't find", "search the web"],
        ...
        },
        {
            ...
            "pass_keywords": ["don't see", "not found", "no match", "don't have", "couldn't find", "search the web"],
